...
<body>
<div style="float:right;padding-top:30px;padding-right:5px"><?php if($chinese) { ?><a href="index.php?e">English Version</a><?php } else { ?><a href="index.php?c">中文版</a><?php } ?></div>
<div id="divLogo"><a href="index.php"><img src="logo.gif" width="369" height="50" border="0" alt="cn.bbs.*" /></a></div>
<div id="divMenu"><br />
<?php
	if($chinese) {
?>
...
<div align="center">
<form action="https://panel.cn-bbs.org/loginout.php" method="post" id="frmPanel" name="frmPanel">Username：<input type="text" name="name" maxlength="16" class="loginbox" /><br />
Password：<input type="password" name="password" maxlength="40" class="loginbox" /><br />
<div style="margin-top:10px"><input type="submit" value="Login" class="loginbtn" /> <input type="button" value="Register" class="loginbtn" onclick=
"location.href='https://panel.cn-bbs.org/register.php';" /> <input type="button" value="Forget Password?" class="loginbtn" onclick="location.href='https://panel.cn-bbs.org/lostpw.php';" /></div>
</form>
</div>
<?php
	}
